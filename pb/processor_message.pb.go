...
type CPU struct {
	...
	Brand         string  `protobuf:"bytes,1,opt,name=brand,proto3" json:"brand,omitempty"` // brand of the CPU (ex: Intel)
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x06, 0x6d, 0x61, 0x78, 0x47, 0x68, 0x7a, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62,
