...
func (server *LaptopServer) UploadImage(stream pb.LaptopService_UploadImageServer) error {
	...
	if laptop == nil {
		return logError(status.Errorf(codes.InvalidArgument, "laptop %s doesn't exitst", laptopID))
	}
...
func contextError(ctx context.Context) error {
	...
	case context.Canceled:
		return logError(status.Error(codes.DeadlineExceeded, "request is canceled"))
